...
def eval_tool(prediction, referneces=None, metric='Meteor', soda_type='c', verbose=False, lang=None):
...
def eval_soda(p, ref_list,verbose=False, lang=None):
    score_sum = []
    for ref in ref_list:
        r = eval_tool(prediction=p, referneces=[ref], verbose=verbose, soda_type='c', lang=lang)
