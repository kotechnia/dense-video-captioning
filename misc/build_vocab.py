...
file_path_list = ["/home/jaewon/work/dense-video-captioning/sample/test_video.json"]
output_path = '/home/jaewon/work/dense-video-captioning/sample/vocabulary.json'
count_threshold = 1
...
def build_vocab(file_path_list, output_path, count_threshold):
    mark = [',', ':', '!', '_', ';', '-', '.', '?', '/', '"', '\\n', '\\']
    count_vocal = {}
...
if __name__ == '__main__':
    build_vocab(file_path_list, output_path, count_threshold)